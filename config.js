...
const CONFIG = {
    ...
    seatedRow: {
        ...
        forwardReachTorsoRatio: 0.30,
        // Return tolerance (proportion of torso length from baseline)
        returnTolerance: 0.15,
        // State persistence (ms)
        statePersistenceMs: 180,
        // Calibration duration (ms)
        calibrationDurationMs: 2000,
        // Maximum allowed torso lean (degrees) - not enforced, just measured
        maxTorsoLean: 45
    },
